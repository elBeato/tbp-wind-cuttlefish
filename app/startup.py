...
BELOW_MIN_WINDSPEED = {station: 0 for station in range(15500)}  # Initialize as 0 (meaning no email sent yet)
...
def wind_speed_excess(
    ...
    if speed > wind_trigger:
        ...
        if station_counter <= 0 and BELOW_MIN_WINDSPEED[station_id] == 0:
            send_email(
