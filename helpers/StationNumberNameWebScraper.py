...
options.page_load_strategy = "eager"  # DOM is ready but external resources (images) are still loading
...
for n in error_stations:
    ...
    station_name = driver.find_element(By.CSS_SELECTOR, "span.wgs_station_name.spotname-truncate").text
...
with open('output_error_stations_2.txt', 'w') as file:
